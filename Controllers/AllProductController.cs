...
namespace WebApplication1.Controllers
{
    public class AllProductController : Controller
    {
        ...
        public async Task<ActionResult> Index(int? page, string searchString, double? minimumPrice,
            double? maximumPrice, List<int> categoryCheckIds, int? sortBy, List<String> SexCheckIds, FormCollection formCollection)
        {
            FilterViewModel filterViewModel = getFilteredProducts(minimumPrice, maximumPrice, categoryCheckIds, sortBy, formCollection);
            ...
            double? maximumPrice, List<int> categoryCheckIds, int? sortBy, FormCollection formCollection)
        {
            ...
            if (formCollection["CheckboxNam"] == null)
